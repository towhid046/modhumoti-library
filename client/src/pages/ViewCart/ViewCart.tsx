...
const commonInputClassName = "w-full px-3 py-2 border rounded focus:outline-none duration-300 transition focus:border-primary-color my-2 transaction duration-300 focus:border-opacity-70";
                ...
                <div className="md:grid md:grid-cols-3 gap-8">
                    ...
                    <div className="md:col-span-2 bg-white p-6 rounded-md shadow-md">
                        <div className="overflow-x-auto">
                            <table className="w-full min-w-max border-collapse mb-5">
                                <thead>
